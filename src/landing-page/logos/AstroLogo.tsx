// ═══════════════════════════════════════════════════════════════════════════
// OBITEACH: logos/AstroLogo.tsx — A LOGO AS A COMPONENT (SVG)
// ═══════════════════════════════════════════════════════════════════════════
// Logos are just React components returning <svg>. This file is a static
// SVG with Astro's paths. Two classes do the theme switching:
//   className="dark:fill-white"  → white logo in dark mode
//   fill="#545454"               → gray logo in light mode
// (fill is an SVG attribute — className takes over in dark mode.)
//
// The other 3 logo files (OpenAILogo, PrismaLogo, SalesforceLogo) are the
// same pattern with different paths.
//
// ECO PULSE: only used by Clients.tsx, which nothing renders — delete all
// 4, or keep + swap for real partners. To make YOUR logo component, export
// a <svg> with your paths the same way.
// ═══════════════════════════════════════════════════════════════════════════
